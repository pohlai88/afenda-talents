...
export async function invite(page: Page, name: string, email: string): Promise<string> {
...
export async function completeAssessment(page: Page, link: string): Promise<void> {
