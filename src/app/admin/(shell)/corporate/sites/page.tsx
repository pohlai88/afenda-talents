...
export default async function SitesPage() {
  ...
  const [sites, definitions] = await Promise.all([
    db.administrativeSite.findMany({ orderBy: [{ isActive: "desc" }, { name: "asc" }], include: { _count: { select: { serviceCoverage: { where: { isActive: true } }, obligations: { where: { isActive: true } } } } } }),
