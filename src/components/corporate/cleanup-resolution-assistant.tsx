...
export type ObligationPartyResolutionGroup = {
  ...
  parties:Array<{ counterpartyId:string; counterparty:string; roleCode:string; isPrimary:boolean; isActive:boolean }>;
};
